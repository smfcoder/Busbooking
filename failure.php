...
?>  
    <!-- DataTales Example -->
   	<div class="container" style="margin-top: 200px;margin-bottom: 50px;">
   		<div class="row">
          <h1 style="color: red;">Your Booking is Failed.<br>Please select the bus properly and enter correct details.Click here to view <a href="view_buses.php">Buses</a></h1>;
        <?php
...
?>
		<div class="text-center">
			<div class="copyright">
				    &copy; Developed By Sandhya, Saloni, Sayali, Sonal.
                <div class="credits">
                    <!-- 
