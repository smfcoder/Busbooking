        ...
        <form action="book.php" method="POST">
          ...
          <input type="hidden" name="busid" value="<?php echo($busid); ?>">
            <div class="form-group row">
              <label for="" class="col-sm-4 col-form-label">Source(From)</label>
              <div class="col-sm-10">
                  <input type="text" name="source" class="form-control" placeholder="Source City" value="<?php echo $source; ?>"  readonly required>
              </div>
            </div>
            <div class="form-group row">
              <label for="" class="col-sm-4 col-form-label">Destination(To)</label>
              <div class="col-sm-10">
            ...
            <div class="form-group row">
              <label for="" class="col-sm-4 col-form-label">Resedential Address</label>
              <div class="col-sm-10">
                  <textarea type="text" name="address" class="form-control" placeholder="Resedential Address" required></textarea>
              </div>
            </div>
            <div class="form-group row">
              <label for="" class="col-sm-4 col-form-label">Total Seats to reserve</label>
              <div class="col-sm-10">
                  <input type="text" name="reserseats" class="form-control" placeholder="Number of Seats to reserve" required>
              </div>
            </div>
            <div class="form-group row">
              <label for="" class="col-sm-4 col-form-label">Date for reservation</label>
              <div class="col-sm-10">
