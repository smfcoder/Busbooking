...
?>
        <div style="margin-top: 50px;">  
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-red-800" style="color: red;">Your Booking is failed.<br></h1>
            <h3 class="h3 mb-0 text-gray-800"><a href="index.php">Click here</a>to redirect to dashboard.</h3>
          </div>
        </div>
          </div>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>  &copy; Developed By Sandhya, Saloni, Sayali, Sonal.</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
