<?php
   ...
   if(isset($_POST['submit']))
   {
        ...
        if($login!="" && $pass!="")
        {
            $db="SELECT * FROM admin WHERE username='$login' and pass ='$pass'";
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div>        <img src="img/abc1.jpg" class="img-responsive" alt=""></div>
                ...
                <div class="p-5">
                  ...
                  <form class="user" action="login.php" method="POST">
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" name="user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address...">
                    </div>
                    <div class="form-group">
