...
<?php
  ...
  $querym="SELECT * FROM contactus;";
  $querym_exe=mysqli_query($sql,$querym);
  $no_messages=mysqli_num_rows($querym_exe);
  $rowm=mysqli_fetch_array($querym_exe);
?>
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Buses Deployed</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $no_buses; ?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo($cust); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Contact Us Messages<br><a href="view_message.php">(Click here to view messages)</a></div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $no_messages; ?></div>
                    </div>
                    <div class="col-auto">
