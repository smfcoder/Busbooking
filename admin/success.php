...
?>
        <div style="margin-top: 50px;">  
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-green-800" style="color: green;">Your Booking is successful.<br></h1>
            <h2 class="h3 mb-0 text-green-800"><a href="index.php">Click here</a>to redirect to dashboard.</h>
          </div>
        </div>
          </div>
